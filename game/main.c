...
internal Asset *global_test_sound;
...
game_init(OpenGLFunctions *gl)
{
    ...
    global_test_sound = asset_from_path(s8_literal("../assets/audio/laser.wav"));
}
                       ...
                       F64 frametime_in_s)
{
    ...
    else if (is_key_typed(input, 'l'))
    {
        play_audio_source(global_test_sound);
    }
