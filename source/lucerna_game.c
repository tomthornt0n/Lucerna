...
// NOTE(tbt): everything is very bad
...
// NOTE(tbt): not a very nice api - breaks trying to think of strings as immutable
internal B32
...
// TODO(tbt): redo soon please - what the hell was I thinking when I wrote this?
